...
export const createOrganisation = async (
  ...
  if (error) {
    throw new Error(
      `An error has occured when creating an organisation: ${error.message}`
    );
  }
};
...
export const getOrganisationById = async (
  ...
  if (error) {
    throw new Error(
      `An error has occured when retrieving an organisation: ${error.message}`
    );
  }
...
export const updateOrganisation = async (
  ...
  if (error) {
    throw new Error(
      `An error has occured when updating an organisation: ${error.message}`
    );
  }
...
export const deleteOrganisation = async (id: string): Promise<void> => {
  ...
  if (error) {
    throw new Error(
      `An error has occured when deleting an organisation: ${error.message}`
    );
  }
};
...
export const addUser = async (
  ...
  if (error) {
    throw new Error(
      `An error occured while adding user to organisation: ${error.message}`
    );
  }
};
...
export const removeUser = async (
  ...
  if (error) {
    throw new Error(
      `An error has occured whilst removing user from organisation: ${error.message}`
    );
  }
};
